...
class Libgpkg < Formula
  homepage "https://github.com/boundlessgeo/libgpkg"

  head "https://github.com/boundlessgeo/libgpkg", :using => :hg, :branch => "default"
  ...
  def caveats; <<-EOS.undent
      ...
      Make sure to review Usage (extension loading) and Function Reference docs:
        https://github.com/boundlessgeo/libgpkg/wiki/Home
